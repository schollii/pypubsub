...
from pubsub.core.treeconfig   import TreeConfig
...
def test0_CreateRoot():
    ...
    assert_raises(ValueError, Topic, treeConfig, nameTuple, description, msgArgsInfo)
    ...
    def badListener2(arg1=None): pass # extra is optional
...
def test1_SubUnsub():
    ...
    assert_raises(ListenerMismatchError, obj.subscribe, badListener)

    # try unsubscribe
    obj.unsubscribe(listener1)
    assert_true( obj.hasListeners() )
    assert_equal(obj.getListeners(), [listener2])
...
def test2_CreateChild():
    ...
    reqdArgs = ('arg3',)
    assert_raises(MessageDataSpecError, tryCreate, argsDocs, reqdArgs)
    reqdArgs = ()
    assert_raises(MessageDataSpecError, tryCreate, argsDocs, reqdArgs)
