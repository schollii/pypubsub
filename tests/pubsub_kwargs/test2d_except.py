...
def testHandleExcept1a():
    ...
    assert_raises(pub.ExcHandlerError, pub.sendMessage, 'testHandleExcept1a')
    ...
    class UncaughtExcListener:
        def __call__(self, listenerStr=None, excTraceback=None):
            ...
            def validateTB(tbItem, eFN, eLine, eFnN):
                ...
                assert_equal( tbItem[1], eLine )
                assert_equal( tbItem[2], eFnN)
            ...
            assert_equal( len( excTraceback.getFormattedList() ), len(tb)+1 )
...
def testHandleExcept2():
    ...
    pub.setListenerExcHandler(None)
    assert_raises( RuntimeError, pub.sendMessage, testTopic)
...
def testNoExceptionHandling1():
    ...
    assert_raises( RuntimeError, pub.sendMessage, 'testNoExceptionTrapping')
