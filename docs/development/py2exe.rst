...
pubsub, with `py2exe`_ and `cx_Freeze`_ packaging tools.
...
Pubsub supports two different messaging protocols namely ``args1`` and
...
pubsub and discuss the setup script to package it using *py2exe* or
